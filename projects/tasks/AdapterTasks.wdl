...
task GetCromwellMetadata {
  input {
    ...
    String docker = "us.gcr.io/broad-gotc-prod/hca-adapter-tools:optimized-loom-merge"
    Int cpu = 1
...
task MergeLooms {
  input {
    ...
    String docker = "us.gcr.io/broad-gotc-prod/hca-adapter-tools:optimized-loom-merge"
    Int cpu = 1
    Int memory_mb = ceil((size(output_looms, "MiB") * 2)) + 40000
    Int disk_size_gb = ceil((size(output_looms, "GiB") * 2)) + 75
  }
