#!/usr/bin/env python3
"""Smoke test for covdb hom-ref imputation + checkpoint (no artifact filter).

This isolates whether the checkpoint NPE is tied to artifact filtering.
"""
...
def main() -> None:
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        print("smoke_test_finalize_mt_with_covdb_no_artifact: PASS")
