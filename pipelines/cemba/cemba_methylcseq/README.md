...
* The [CEMBA.wdl](CEMBA.wdl) implements the workflow by importing individual modules ("tasks" written in the [WDL script](https://github.com/broadinstitute/warp)).
...
| Align | [Bismark v0.21.0](https://www.bioinformatics.babraham.ac.uk/projects/bismark/)  | Map multiplexed samples as single-end with --bowtie2 |
quay.io/broadinstitute/bismark:0.21.0 |
...
| Get MethylationReport | Produce methylation report for duplicates-filtered BAM |
...
| GetMethylationReport | [Bismark v0.21.0](https://www.bioinformatics.babraham.ac.uk/projects/bismark/)  | Produce methylation report for reads above map quality and below map quality | 
...
| Sort | [Picard v2.18.23](https://broadinstitute.github.io/picard/) | Sort in coordinate order after adding read group | 
quay.io/broadinstitute/picard:2.18.23 |
| IndexBam |    | Index the output BAM | 
...
| IndexBam.bam_index_output | Index file for the final BAM  | INDEX | 
| GetMethylationSiteVCF.methylation_vcf | VCF file demarcating methylation sites  | VCF | 
| GetMethylationSiteVCF.methylation_vcf_index | Index file for the VCF  | INDEX 
...
| FilterDuplicates.metric_remove_dup_output | Duplication metrics generated by Picard | TXT |
