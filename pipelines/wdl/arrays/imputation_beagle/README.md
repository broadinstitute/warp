...
The ImputationBeagle workflow (v3.0.0) is a WDL-based pipeline for genotype imputation using [Beagle](https://faculty.washington.edu/browning/beagle/beagle.html). This workflow processes multi-sample VCF files, performing phasing and imputation by chromosome chunks to increase genetic variant resolution.
