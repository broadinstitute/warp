  ...
  call Calling.Reblock as Reblock {
    ...
    call QC.ValidateVCF as ValidateVCF {
      input:
        ...
        gatk_docker = "us.gcr.io/broad-gatk/us.gcr.io/broad-dsde-methods/broad-gatk-snapshots/gatk-remote-builds:mshand-f1e7265aebf480593809a01453db932beddc5cbd-4.2.6.1-43-gf1e7265ae"
    }
