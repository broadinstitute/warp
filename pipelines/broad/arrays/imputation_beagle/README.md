...
| `CalculateContigsToProcess`            | Determine which contigs will be processed by the workflow                          | multi_sample_vcf, contigs                               | Extract contigs from input VCF and filter by allowed contigs                     |
