...
| sequencing_input_id | The sequencing_input_id listed in the pipeline configuration file |
| cell_suspension_name | The optional string provided in the pipeline configuration to further identify samples |
...
| `cell_names` | ---| The unique identifier for each cell; read from the sequencing_input_id |
