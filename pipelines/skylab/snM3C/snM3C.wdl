...
workflow snM3C {
    ...
    call rename_outputs {
        input:
            ...
            reference_version = hisat_paired_end.reference_version,
...
task rename_outputs {
    input {
        Array[String] name_sorted_bams
        Array[String] unique_reads_cgn_extraction_allc
        Array[String] unique_reads_cgn_extraction_tbi
        Array[String] reference_version
        Array[String] all_reads_dedup_contacts
        Array[String] all_reads_3C_contacts
        Array[String] chromatin_contact_stats
        Array[String] unique_reads_cgn_extraction_allc_extract
        Array[String] unique_reads_cgn_extraction_tbi_extract
