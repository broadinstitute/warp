...
=======
    temp = df[['sequencing_process__provenance__document_id','sequencing_input__biomaterial_core__biomaterial_id', 'donor_organism__genus_species', 'library_preparation_protocol__library_construction_approach', 'specimen_from_organism__organ','project__provenance__document_id']]
    temp.columns = ['entity:participant_lane_set_id','input_name', 'species', 'library', 'organ','project__provenance__document_id']
>>>>>>> Stashed changes
