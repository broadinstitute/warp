...
python workspace_controller.py get_participant_table \
--workspace-name $name \
--participant-table-name participant \
--output-name participant.tsv

python workspace_controller.py create_participant_lane \
--input-name participant.tsv \
--output-prefix participant_lane

python workspace_controller.py upload_participant \
--workspace-name $name \
