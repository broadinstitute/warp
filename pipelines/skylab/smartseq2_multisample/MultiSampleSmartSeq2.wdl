...
workflow MultiSampleSmartSeq2 {
  ...
  parameter_meta {
    ...
    input_id_metadata_field: "String that describes what was passed as input_ids"
    input_name_metadata_field: "String that describes what was passed as input_names"
