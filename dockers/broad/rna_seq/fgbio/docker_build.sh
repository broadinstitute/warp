...
# Registries and tags
GCR_URL="us.gcr.io/broad-gotc-prod/fgbio"
QUAY_URL="quay.io/broadinstitute/gotc-prod-fgbio"
...
function main(){
    ...
    IMAGE_TAG="$DOCKER_IMAGE_VERSION-$FGBIO_VERSION-$TIMESTAMP"

    echo "building and pushing GCR Image - $GCR_URL:$IMAGE_TAG"
    docker build --no-cache -t "$GCR_URL:$IMAGE_TAG" \
        --build-arg FGBIO_VERSION="$FGBIO_VERSION" "$DIR"
