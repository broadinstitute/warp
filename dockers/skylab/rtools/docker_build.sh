...
# Registries and tags
GCR_URL="us.gcr.io/broad-gotc-prod/rtools"
#QUAY_URL="quay.io/broadinstitute/gotc-prod-rtools" # Update and uncomment push block below after setting up quay repo

# Necessary tools and help text
TOOLS=(docker gcloud)
HELP="$(basename "$0") [-h|--help] [-t|tools] -- script to build the rtools image and push to GCR
where:
