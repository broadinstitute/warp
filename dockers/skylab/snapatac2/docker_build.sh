...
TOOLS=(docker gcloud)
HELP="$(basename "$0") [-h|--help] [-b|--bwa_version] [-t|tools] -- script to build the SAMTOOLS/BWA image and push to GCR & Quay

where:
    -h|--help Show help text
    -b|--bwa_version Version of SNAPATAC2 to use (default: SNAPATAC2=$SNAPATAC2_VERSION)
...
function main(){
    ...
    IMAGE_TAG="$DOCKER_IMAGE_VERSION-$SNAPATAC2_VERSION-$TIMESTAMP"
