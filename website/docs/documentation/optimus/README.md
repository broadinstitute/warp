...
_Check out the [Optimus Publication Methods](optimus.methods.md) to get started!_
:::
...
| Tar_star_reference  | Cloud path to TAR file containing a species-specific reference genome and gtf; it is generated using the [BuildIndices.wdl](https://github.com/broadinstitute/warp/tree/master/pipelines/skylab/build_indices)                                                                         | NA                                 |
