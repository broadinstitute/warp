...
| 4 | RNA processing | Aggregate cohort-level RNA outputs | [RNA-SeQC2 Batched Aggregation](./rnaseqc2_aggregate_batched) | [rnaseqc2_aggregate_batched.wdl](https://github.com/broadinstitute/warp/blob/develop/all_of_us/rna_seq/GTEx/rnaseqc2_aggregate_batched.wdl) | Use aggregated expression/QC summaries for downstream phenotype prep and cohort QC review. |
...
* **RNA-level aggregation:** `rnaseqc2_aggregate_batched.wdl` provides bounded-batch RNA-SeQC2 aggregation for large cohorts. `aggregate_rsem_results.wdl` remains available for cohort-level RSEM aggregation.
