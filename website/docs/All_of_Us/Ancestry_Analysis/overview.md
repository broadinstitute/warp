---
title: Ancestry Pipelines
className: aou-doc-page
---

<div className="aou-folder-text">
The following pipelines are used to calculate categorical genetic ancestry.

## Quick Summary

* **Purpose:** Convert and filter large callsets, build shared high-quality site sets, and infer ancestry labels.
* **Primary Outputs:** Per-chromosome VCFs, filtered intersection VCFs, and ancestry prediction result tables/plots.
