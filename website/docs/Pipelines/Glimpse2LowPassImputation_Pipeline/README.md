...
| `UpdateHeader`                                       | Update VCF header with reference info                              | Filtered VCF or re-annotated VCF                                                                       | Updates VCF headers with reference dictionary information and optionally adds pipeline metadata               |
