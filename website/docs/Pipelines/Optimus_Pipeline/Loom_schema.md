...
| `duplicate_reads` | [TagSort](https://github.com/broadinstitute/warp-tools/tree/develop/tools/TagSort) | Not currently calculated for Optimus output. The number of duplicate reads. |
