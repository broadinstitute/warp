...
An [example configuration file (JSON)](https://github.com/broadinstitute/warp/blob/master/pipelines/skylab/smartseq2_single_nucleus_multisample/mouse_example.json) is available to test the pipeline.
...
| fastq2_input_files | Cloud locations for each read2 file | Array of strings |
