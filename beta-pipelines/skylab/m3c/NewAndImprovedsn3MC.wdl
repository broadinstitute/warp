...
workflow NewAndImprovedsn3MC {
  ...
  call trim {
    input:
     r1_sorted = sort_r1_and_r2.r1_sorted,
     r2_sorted = sort_r1_and_r2.r2_sorted
  }

  call  hisat_3n_pair_end_mapping_dna_mode {
    input:
     r1_trimmed = trim.r1_trimmed,
     r2_trimmed = trim.r2_trimmed
  }
  ...
  call hisat_3n_single_end_r1_mapping_dna_mode {
    input:
      split_r1 = split_unmapped_reads.split_r1
  }

  call hisat_3n_single_end_r2_mapping_dna_mode {
    input:
      split_r2 = split_unmapped_reads.split_r2
  }
