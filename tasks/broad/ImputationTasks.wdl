...
task PhaseAndImputeBeagle {
  input {
    ...
    Int memory_mb = 64000          # value depends on chunk size, the number of samples in ref and target panel, and whether imputation is performed
    Int xmx_mb = 60000             # I suggest setting this parameter to be 85-90% of the memory_mb parameter
