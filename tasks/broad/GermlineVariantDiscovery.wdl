...
task HaplotypeCaller_GATK4_VCF {
  input {
    ...
    File? dragstr_model
    String gatk_docker = "gcr.io/broad-gotc-prod/test:emeryj.test.merge.gatk.docker"
...
task Reblock {
  ...
  input {
    ...
    String docker_image = "gcr.io/broad-gotc-prod/test:emeryj.test.merge.gatk.docker"
  }
