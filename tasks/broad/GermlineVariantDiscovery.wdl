...
task HaplotypeCaller_GATK4_VCF {
  input {
    ...
    File? dragstr_model
    String gatk_docker = "us.gcr.io/broad-dsde-methods/broad-gatk-snapshots:1.2.0-4.2.6.1-42-g8c348aa-SNAPSHOT-1658941911"
...
task Reblock {
  ...
  input {
    ...
    String docker_image = "us.gcr.io/broad-dsde-methods/broad-gatk-snapshots:1.2.0-4.2.6.1-42-g8c348aa-SNAPSHOT-1658941911"
